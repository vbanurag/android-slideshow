...
public class IEPreviewView extends TextureView implements IRenderTarget {
    ...
    private void createOffScreenTextures() {
        ...
        for (int mTextureId : mOffScreenTextureIds) {
            ...
            //Set the magnification filter to use the closest color of the coordinates in the texture,
            // and get the pixel color to be drawn by the weighted average algorithm.
            GLES20.glTexParameteri(GLES20.GL_TEXTURE_2D, GLES20.GL_TEXTURE_MAG_FILTER, GLES20.GL_LINEAR);
            // Set the wrap direction S and intercept the texture coordinates to [1/2n, 1-1/2n]. Will lead to never merge with border
